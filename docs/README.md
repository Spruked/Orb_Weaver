...
- [Deployment guide](DEPLOYMENT_ORB_WEAVER_SPRUKED.md)
...
Generated trees, source manifests, and historical architecture references live in [`reference/`](reference/). They are documentation snapshots, not runtime path authorities.
