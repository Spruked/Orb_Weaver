...
const assetPath = path.resolve(__dirname, '../public/orb-skins/factory-orb-v1.png');
...
assert.equal(manifest.path, '/orb-skins/factory-orb-v1.png');
assert.equal(manifest.mime_type, 'image/png');
assert.equal(manifest.color, 'RGBA, 8-bit');
assert.equal(manifest.provenance, 'Original Factory ORB asset supplied by the owner');
